...
const InsightsPage = () => {
  const posts = [
    {
      title: "Why Most User Research Fails",
      preview:
        "Most research fails not because teams don't try, but because people behave differently when they know they're being watched. Here's what we discovered after years of building products.",
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        <header className="text-center mb-16">
          <p className="text-primary text-sm md:text-base font-mono mb-4 tracking-wider">[ INSIGHTS ]</p>
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-foreground mb-6">Latest Insights</h1>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {posts.map((post, index) => (
            ...
            >
              <div className="mb-4">
                <span className="text-primary text-xs font-mono tracking-wider">[ {post.category.toUpperCase()} ]</span>
              ...
              <p className="text-muted-foreground text-sm leading-relaxed mb-4 flex-grow">{post.preview}</p>
        ...
        <div className="mt-16 text-center">
          <p className="text-muted-foreground mb-6">Want to stay updated with our latest insights?</p>
          <Button
            asChild
            size="lg"
