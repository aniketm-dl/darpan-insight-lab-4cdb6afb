  ...
  const capabilities = [
    {
      ...
      description:
        "Plug in analytics, CRM, or survey data — no setup headaches. The tool automatically aligns signals across sources.",
    },
    {
      icon: Bot,
      title: "Build AI Customer Twins",
      description:
        "Generate data-driven personas that think and act like your real users — fully controllable by traits and context.",
    },
    {
      icon: Zap,
      title: "Run Instant Simulations",
      description:
        "Test campaigns, flows, or pricing in hours — not weeks. See which ideas drive engagement, conversion, and sentiment.",
    },
    {
      icon: Route,
    ...
    },
    {
      ...
      description:
        "Save and reuse cohorts by geography, device, or lifecycle to compare audiences and improve decisions over time.",
    },
  ];
    ...
    <section id="what-we-do" className="py-24 bg-background scroll-reveal">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-20 scroll-reveal stagger-1">
          <p className="text-primary text-sm md:text-base font-mono mb-4 tracking-wider">[ HOW IT WORKS ]</p>
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold text-foreground mb-6">From Data to Evidence</h2>

          <div className="max-w-4xl mx-auto mb-12">
            <p className="text-lg md:text-xl text-white leading-[1.5]">
              Ingest your existing data, create AI customer twins, and run simulations to predict real customer
              reactions — before you go live.
            </p>
          </div>
          ...
          {capabilities.map((capability, index) => {
            ...
            return (
              ...
              >
                ...
                <p className="text-base text-[#D6D6D6] leading-[1.65] max-w-[44ch]">{capability.description}</p>
              </div>
            );
          })}
        </div>
