    ...
    <section id="founders" className="section-padding bg-muted/30">
      <div className="section-container">
        <div className="text-center mb-10 scroll-reveal">
          ...
          <h2 className="section-heading mb-3">Meet the founders</h2>
        ...
        <div className="grid md:grid-cols-3 gap-5 max-w-4xl mx-auto">
          {founders.map((founder, index) => (
            <a
              ...
              className={`premium-card text-center hover:border-primary/20 cursor-pointer scroll-reveal-scale stagger-${index + 1}`}
            >
              <div className="relative mb-4">
                <img
                  src={founder.image}
                  alt={founder.name}
                  className="w-28 h-28 rounded-full mx-auto object-cover border border-border"
                />
              </div>

              <h3 className="text-base font-semibold text-foreground mb-2">{founder.name}</h3>
        ...
        <div className="mt-8 text-center scroll-reveal stagger-4">
