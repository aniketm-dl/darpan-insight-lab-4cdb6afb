  ...
  const posts = [
    {
      ...
      preview:
        "Most research fails not because teams don't try, but because people behave differently when they know they're being watched. Here's what we discovered.",
    ...
    <section id="insights" className="py-24 bg-background">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold text-foreground mb-6">Latest Insights</h2>
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-12">
          {posts.map((post, index) => (
            ...
            >
              ...
              <p className="text-muted-foreground text-sm leading-relaxed mb-4">{post.preview}</p>
              {post.isPublished && (
